...
for L1_CONFIG in "${L1_CONFIG_VALUES[@]}"; do
  ...
  # Define output files
  ncu_file="./ncu_reports/l1_cache_test/l1config-${L1_CONFIG}.ncu-rep"
...
echo "All profiling data saved to: ./ncu_reports/l1_cache_test/"
