...
NVBENCH_BENCH(run_mha_varlen_fwd)
    ...
    .add_int64_axis("num_seqs", {1, 2, 4, 8, 16, 32, 64, 128})
    .add_int64_axis("seq_len", {32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384})
    .add_int64_axis("num_heads", {8, 16, 32, 64, 80})
    .add_int64_axis("num_kv_heads", {1, 2, 4, 8, 16, 32, 64})
    .add_int64_axis("head_size", {64, 80, 96, 128, 160})
    .add_int64_axis("page_size", {128, 256, 512, 1024});
